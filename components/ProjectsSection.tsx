      ...
      <div className="container max-w-7xl mx-auto">
        ...
        >
          {projects.map((project) => (
            <motion.div 
              key={project.id}
              className="bg-card border border-[hsl(var(--border))] rounded-xl overflow-hidden group perspective"
              variants={item}
              whileHover={{ 
                y: -15, 
            ...
            >
              <div className="relative h-52 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                  <motion.div 
                    className="p-4 text-white w-full transform translate-y-10 group-hover:translate-y-0 transition-transform duration-300"
                    initial={{ opacity: 0 }}
